...
#line 8 "src/ngx_http_beanstalkd_response.rl"

#line 13 "src/ngx_http_beanstalkd_response.c"
...
#line 9 "src/ngx_http_beanstalkd_response.rl"
...
#line 53 "src/ngx_http_beanstalkd_response.rl"
                    
#line 68 "src/ngx_http_beanstalkd_response.c"
	{
	cs = beanstalkd_put_start;
	}

#line 54 "src/ngx_http_beanstalkd_response.rl"
...
#line 180 "src/ngx_http_beanstalkd_response.rl"
    
#line 181 "src/ngx_http_beanstalkd_response.rl"
    
#line 204 "src/ngx_http_beanstalkd_response.c"
	{
	if ( p == pe )
		goto _test_eof;
	switch ( cs )
...
#line 24 "src/beanstalkd_common.rl"
	{
        dd("done it!");
        *done_addr = 1;
    }
...
st92:
	if ( ++p == pe )
		goto _test_eof92;
case 92:
#line 328 "src/ngx_http_beanstalkd_response.c"
	goto st0;
st13:
	if ( ++p == pe )
		goto _test_eof13;
...
#line 182 "src/ngx_http_beanstalkd_response.rl"
